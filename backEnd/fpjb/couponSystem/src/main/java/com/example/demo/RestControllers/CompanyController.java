...
//	public ResponseEntity<Coupon> login(@RequestBody Company comp)
//	{
//		companyFacade.login(comp.getCompName(), comp.getPassword(), ClientType.company);
...
//	}
	...
	public ResponseEntity<List<Coupon>> getAllCoupons() {
		...
		List<Coupon> allCoupons = (List<Coupon>) companyFacade.getAllCoupons();
	...
	public ResponseEntity<List<Coupon>> getAllCouponsByDate(@PathVariable LocalDate date) {
		...
		// ArrayList<Coupon> allCoupons = (ArrayList<Coupon>)
		// companyFacade.getCouponByDate(date);
